/**
 * patch_add_seasonal_chart.js — Adds seasonal-chart.js script tag to all 97 asset HTML files.
 *
 * Inserts:  <script src="../js/seasonal-chart.js" defer></script>
 * Before:   <script src="../js/ui.js" defer></script>
 *
 * Run once from the seasonal-dashboard/ directory:
 *   node patch_add_seasonal_chart.js
 */
...
const INSERT     = '<script src="../js/seasonal-chart.js" defer></script>\n  ';
...
files.forEach(file => {
  ...
  try {
    ...
    if (content.includes('seasonal-chart.js')) {
